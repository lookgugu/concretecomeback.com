...
tags: ["injury-prevention", "balance", "training", "safety"]
featured: false
draft: false
---
...
**Ankle alphabet (1 minute per side, 2 minutes total).** Sitting, or standing near your support, lift one foot slightly off the ground and "write" the alphabet in the air with your big toe, capital letters, slow and controlled. Switch feet and repeat so each ankle gets a turn — it's the lifted foot doing the alphabet, not the one you're standing on, so switching sides is what actually trains both ankles' fine-motion control. (Standing rather than seated adds a smaller balance benefit for your stance leg at the same time, but that's a bonus, not the point of this particular drill.) This is mobility and motor-control work, not a loaded balance challenge like the drills around it — the foot's off the ground, so there's no weight to correct under. It still earns its place here: it builds the fine range of ankle motion and control that the loaded balance work above depends on, which matters most if you're working back from a sprain and your range is still limited.

**Single-leg reach (1 minute per side, 2 minutes total).** Standing on one leg, near your support, reach the opposite foot forward, then to the side, then behind you, tapping the ground lightly each time before returning to balance. Switch legs halfway through. This trains proprioception through movement rather than a static hold, which is closer to what skating actually demands.
...
Eyes-closed weight shifts are two-footed and gentler than everything else here, so they don't need to wait either — use them from the start, and as the easier option on a day the single-leg work feels like too much.

The single-leg reach is the one that follows the foundation's own progression: solid ground before an unstable surface, eyes open before eyes closed, support within arm's reach at every step, never skipping ahead because a level felt easy once — layer the reach in once that single-leg foundation feels stable. If you ever feel like you're about to fall rather than just wobble, on the reach or the foundation itself, that's the sign to back off a level and get a hand on your support, not push through it — the training only works if the corrections stay small and controlled.
