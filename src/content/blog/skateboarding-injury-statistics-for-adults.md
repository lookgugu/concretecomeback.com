---
title: "Skateboarding Injury Statistics: What the Numbers Actually Say"
description: "A clear-eyed look at skateboarding injury data for adults — what actually gets hurt, how often, and what the numbers do and don't tell you."
pubDate: 2026-09-24
author: "Jo Fairweather"
authorAge: 52
authorBio: "Physiotherapist and skater. Came back to skating at 49 and hasn't stopped."
tags: ["safety", "injury-prevention", "research", "gear", "protective-equipment"]
featured: false
draft: false
---
...
Injury-data compilations drawn from emergency-room records consistently point to the same pattern, give or take a few points depending on the dataset: wrist and forearm injuries are the single largest category, commonly cited in the range of 30% of skateboarding injuries, with fractures specifically making up a large share of that. Head and face injuries are the next major category, generally cited around a fifth of all injuries — smaller in raw count than wrist injuries, but disproportionately represented in the more serious outcomes.

That split is the whole logic behind the standard skate gear recommendation. Wrists get hurt more often because the instinctive hand-catch on a fall is close to universal and very hard to train out, especially in adults relearning to fall. Heads get hurt less often but worse, because a head impact doesn't scale down the way a wrist impact does.
...
Aggregated injury statistics are useful for spotting patterns — which body parts, which rough proportions, which direction the adult share is trending — but they're a blunt instrument for anything more specific than that. They don't separate out skating surface, skill level, terrain choice, or whether gear was worn, and most of the widely-cited compilations are secondary analyses of broader ER datasets rather than a study designed around skateboarding specifically. Treat the percentages here as a reasonable general picture, not a precise clinical finding.

What they do support, consistently and across sources, is the same practical conclusion: most of the injury risk in skateboarding concentrates in a couple of predictable categories, both of which respond well to specific, unglamorous protective gear. That's a genuinely useful thing to know, even if the exact percentage varies a few points depending on which dataset you're reading.
