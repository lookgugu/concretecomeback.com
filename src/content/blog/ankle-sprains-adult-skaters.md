...
Some symptoms need care the same day, not a wait-and-see approach. If you can't put any weight at all on the ankle right after it happens, if the joint looks visibly deformed, or if the pain is severe and out of proportion to what you'd expect from a sprain, treat that as a possible fracture and get to urgent care or the ER for imaging that day — the same rule this site uses for any inability to bear weight after a fall. Don't spend the first 48 hours self-managing something that needs an X-ray.
