...
Some symptoms need care the same day, not a wait-and-see approach. If you can't put any weight at all on the ankle — whether that's immediately after the fall or once swelling and pain build up over the following hours — if the joint looks visibly deformed, or if the pain is severe and out of proportion to what you'd expect from a sprain, treat that as a possible fracture and get to urgent care or the ER for imaging that day — the same rule this site uses for any inability to bear weight after a fall, full stop, not just in the first few minutes. Don't spend 48 hours self-managing something that needs an X-ray.
