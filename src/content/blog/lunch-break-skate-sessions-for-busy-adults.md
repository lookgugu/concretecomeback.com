---
title: "The Lunch Break Skate: Fitting Real Sessions Into a Packed Adult Life"
description: "A practical guide to squeezing genuine skate practice into a workday — nearby parks, early and late sessions, and a 25-minute lunch structure that works."
pubDate: 2026-08-25
author: "Sam Torres"
authorAge: 44
authorBio: "Came back to skating at 40. Community organiser and one of the founders of the Portland Adult Skate Sessions."
tags: ["getting-started", "motivation", "habit-building", "beginner"]
featured: false
draft: false
---
...
## Early mornings and lit evenings, when lunch doesn't work

Not every job has a real lunch break, and not every nearby spot is usable at midday. Two other windows are worth checking before you write off skating on workdays entirely.

Some indoor parks open well before normal business hours specifically to catch commuters and early risers — worth a call or a look at their site, since hours vary a lot by location; an indoor park is enclosed and purpose-built, so the traffic question doesn't apply. An outdoor evening session is different: a lit plaza can still be a real pedestrian or vehicle route, especially right after work when commuter traffic is at its heaviest, not lighter. Apply the same check as the lunch spots — lit or open, close enough to be worth the trip, and genuinely closed to cars and clear of foot traffic during your window, confirmed by walking or watching it once rather than assumed from how it looks passing by.
...
**Tell one coworker.** Not for accountability theater — just so someone at work knows "gone for a bit, back by 1" is a normal Tuesday thing for you, not something you have to explain or hide.

**Don't wait for the perfect spot.** A mediocre stretch of flat pavement you can reach in six minutes beats a great park that's twenty-five minutes each way. On a lunch break, proximity wins over quality almost every time.

## Why this window matters more than it seems

A lunch or evening session isn't a lesser version of "real" practice — it's often the difference between skating three or four times a week and skating only on weekends, if at all. The weekday sessions are what keep the skill warm between the bigger trips to a proper park. They also do something less measurable: they turn skating from an occasional event you plan around into something that's just part of your regular week, the same way a lunchtime walk or a gym visit might already be.

If you've been telling yourself you don't have time to skate during the week, the honest answer is usually that you have twenty-five minutes somewhere in your day — you just haven't gone looking for where it is yet.
